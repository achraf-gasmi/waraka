...
The agents/, graph/, models/, tools/, and config/ directories alongside this
file are GENERATED by scripts/sync_hf_spaces.sh (or .ps1) from the root
packages of the same name -- do not hand-edit them. Edit the root versions
