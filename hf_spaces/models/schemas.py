...
class Transaction(BaseModel):
    ...
    structuring_below_threshold: bool = False
    multiple_transactions_same_beneficiary: bool = False
    no_commercial_justification: bool = False
    weak_aml_destination: bool = False
    activity_inconsistency: bool = False
